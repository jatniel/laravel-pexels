# A Laravel package to integrate Pexels API for photos and videos
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-pexels.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-pexels)
...
```bash
php artisan vendor:publish --tag="laravel-pexels-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-pexels-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-pexels-views"
```

## Usage

```php
$pexels = new Jatniel\Pexels();
echo $pexels->echoPhrase('Hello, Jatniel!');
```
...
- [Jatniel Guzmán](https://github.com/Jatniel)
